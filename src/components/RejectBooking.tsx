...
const RejectBooking: React.FC<BookingCardProps> = ({ isOpen, onClose, booking }) => {
  return (
        ...
        <Card className="border-none">
          ...
          <User className="text-gray-500 h-4 w-4" />
            ...
            <div className="flex justify-between pt-5">
              ...
              <span className=" text-gray-600">{booking.requestGenerated}</span>
            </div>
            ...
            <div className="flex justify-between">
              ...
              <span className=" text-gray-600">{booking.cabinNumber}</span>
            </div>
